...
Found on 2026-09-13 during a full code review that included driving the app against a real running instance, tracked on the Phase 3 kanban as `#GC-Phase3-Bug-1` … `-9`. Bug 1 is fixed (see Done, above); the numbering below is kept as-is to match the kanban card IDs and this list's own internal cross-references.
